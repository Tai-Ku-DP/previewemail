...
|--------|----------|-------------|
| GET | /previewmail/templates | List all templates |
| POST | /previewmail/templates | Create new template |
| PUT | /previewmail/templates/:id | Update template |
| DELETE | /previewmail/templates/:id | Delete template |
| GET | /previewmail/templates/:alias | Fetch by alias — dùng trong app khi gửi email |
...
const html = template.compile({ fullName: 'John', ...data })
...
| **V2.0** | Tháng 3–4 | `@previewmail/nestjs` core + **MongoDB adapter** + full security |
...
previewmail/
  packages/
    ui/                      # Frontend — Next.js 14 App Router + Tailwind
    nestjs/                  # NestJS package core
...
*PreviewMail · Open Source · MIT License · github.com/your-org/previewmail*
